      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="newsletter" className="text-sm">
            <span className="font-medium text-gray-900 dark:text-gray-100">Subscribe to newsletter</span>
            <p className="text-gray-600 dark:text-gray-400">Get updates about new features and tips.</p>
          </label>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          {errors.notifications && <span className="text-sm text-red-500">{errors.notifications.message}</span>}
        </div>
        ...
        <fieldset className="space-y-3">
          ...
          {errors.theme && <span className="text-sm text-red-500">{errors.theme.message}</span>}
        </fieldset>
      </div>
    </div>
  );
